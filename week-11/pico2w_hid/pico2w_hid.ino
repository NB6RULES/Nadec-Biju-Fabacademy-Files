/*
 * pico2w_hid.ino — Raspberry Pi Pico 2W UDP-to-HID Bridge
 *
 * Board    : Raspberry Pi Pico 2 W
 * Core     : arduino-pico by Earle Philhower (supports RP2350)
 * USB Stack: Adafruit TinyUSB  (Tools > USB Stack > Adafruit TinyUSB)
 *
 * Behaviour:
 *   - Connects to ESP_KB WiFi AP with static IP 192.168.4.3
 ...
 *
 * Static IPs:
 *   Pico W  → 192.168.4.2  (pico_hid.ino)
 *   Pico 2W → 192.168.4.3  (this file)
 */
